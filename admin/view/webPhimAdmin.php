...
<div class="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Danh mục các phim</h4>
                                <div>
    ...
    <!--   Core JS Files   -->
    <script src="/phim/public/js/javascripts/jquery.3.2.1.min.js" type="text/javascript"></script>
	<script src="/phim/public/js/javascripts/bootstrap.min.js" type="text/javascript"></script>

	<!--  Charts Plugin -->
	<script src="/phim/public/js/javascripts/chartist.min.js"></script>

    <!--  Notifications Plugin    -->
    <script src="/phim/public/js/javascripts/bootstrap-notify.js"></script>

    <!--  Google Maps Plugin    -->
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>

    <!-- Light Bootstrap Table Core javascript and methods for Demo purpose -->
	<script src="/phim/public/js/javascripts/light-bootstrap-dashboard.js?v=1.4.0"></script>

	<!-- Light Bootstrap Table DEMO methods, don't include it in your project! -->
	<script src="/phim/public/js/javascripts/demo.js"></script>
